...
We provide a simple demo data file named "Task100_ATLASwithCarveMix" which contains 3 subjects of ATLAS dataet. It is important to note that the demo data schema is single-label single-mode, and multi-label multi-modes such as the BRATS dataset can be modified as needed, even make sure if you need intensity normalization for heterogeneous data.
